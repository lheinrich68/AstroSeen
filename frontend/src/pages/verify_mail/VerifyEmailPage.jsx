...
// PAS ENCORE branché à un backend. L'email affiché vient de l'état de
// navigation passé par RegisterPage (location.state.email) ; si la page est
// atteinte directement (rechargement, lien partagé...), on retombe sur un
// texte générique. "Renvoyer l'email" simule l'envoi (toast + cooldown de
// 30s) — à remplacer par un vrai appel API (POST /auth/resend-verification).
